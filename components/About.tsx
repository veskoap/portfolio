...
export default function About({}: Props) {
  return (
    <motion.div
      ...
      className="flex flex-col lg:flex-row relative h-screen text-center md:text-left max-w-7xl 
    ...
    >
      ...
      <div className="space-y-10 px-0 md:px-10">
        ...
        <p className="text-base">
          ...
          amet risus nullam eget. Lectus urna duis convallis convallis. Sed
          risus ultricies tristique nulla. Nullam non nisi est sit amet
          facilisis magna etiam. Euismod lacinia at quis risus. Risus viverra
